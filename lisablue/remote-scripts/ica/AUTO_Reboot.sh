...
then
    ...
    echo "Reboot No. $reboot_count" >> /root/AUTO_Reboot.log
    echo "Rebooting Now..." >> /root/AUTO_Reboot.log
    date >> /root/AUTO_Reboot.log
    ...
    echo "test completed successfully..." >> /root/summary.log
